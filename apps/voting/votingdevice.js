...
*/
  ...
  window.VoteDeviceView = Backbone.View.extend({
    ...
    render: function (options) {
      ...
      var renderedContent = this.template({ questions: questions });
      $(this.el).html(renderedContent);
      return this;
    }
  });
  ...
  window.VotingDevice = Backbone.Router.extend({
    ...
    initialize: function () {
      this.voteDeviceView = new window.VoteDeviceView();
    },
    home: function () {
      var container = $('#container');
      container.html(this.voteDeviceView.render( [ { text: 'Are you voting democrat?', name: 'question1' }, { text: 'Are you male?', name: 'question2' } ]).el);
    },
    blank: function () {
      var container = $('#container');
      container.empty();
